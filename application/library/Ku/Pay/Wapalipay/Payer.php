...
final class Payer extends \Ku\Pay\PayAbstract {
	...
	if ($volid === true && preg_match("/true$/i", $responseTxt)) {
            ...
            return \Ku\Pay::getInstance()->doRecharge($mid,'wapalipay',$params['out_trade_no'],$params['trade_no']) ;
        }
        return false;
    }
    ...
    public function notify($sign, $notifyId) {
        ...
        if ($volid === true && preg_match("/true$/i", $responseTxt)) {
//            $params = $this->getParams();
//            return \Ku\Pay::getInstance()->doRecharge($params['mid'],'wapalipay',$params['out_trade_no'],$params['trade_no']);
            return true;
        }
        return false;
    }
